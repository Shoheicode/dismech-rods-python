    ...
    def compute_force(self, dt):
        ...
        for limb in self.soft_robots.limbs:
            for i in range(limb.ndof):
                ...
                self.soft_robots.stepper.add_force(i, self.f, limb_idx)
            limb_idx += 1
        ...
        for joint in self.soft_robots.joints:
            for i in range(3):
                ...
                self.soft_robots.stepper.add_force(4 * joint.joint_node + i, self.f, joint.joint_limb)
    ...
    def compute_force_and_jacobian(self, dt):
        ...
        for limb in self.soft_robots.limbs:
            for i in range(limb.ndof):
                ...
                self.soft_robots.stepper.add_jacobian(i, i, self.jac, limb_idx)
            limb_idx += 1
        ...
        for joint in self.soft_robots.joints:
            ...
            for i in range(3):
                ...
                self.soft_robots.stepper.add_jacobian(ind + i, ind + i, self.jac, joint.joint_limb)
