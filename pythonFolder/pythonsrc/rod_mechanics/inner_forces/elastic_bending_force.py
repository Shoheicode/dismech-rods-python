...
class ElasticBendingForce(BaseForce):
    ...
    def jacobian_computation(self, i):
        ...
        # print("Self KB local", self.kb_local)
        # print("self.kb_o_d2e", self.kb_o_d2e)
        ...
        # print("SELF D2kappa1Df2", self.D2kappa1DeDf)
        ...
        self.DDkappa1[0:3, 4:7] = -1 * self.D2kappa1De2 + self.D2kappa1DeDf
